...
export default function Form() {
  ...
  const { showWarning: typewriterWarning } = useTypewriterWarning(
    "/projects/oraculux//icons/form/warning.svg",
      ...
      <div className="form__container">
        <div className="form__box" ref={boxRef}>
          ...
          <div className="form__portal">
            <Image 
              src="/projects/oraculux/icons/form/portal.svg"
              ref={imgRef}
          ...
          <form className="form__fields" onSubmit={submitHandler} ref={fieldsRef}>
            <Image
              src="/projects/oraculux/icons/form/eye.png"
              alt={t("form.alt.eye")}
              width={100}
              height={75}
              className="form__eye" 
              ...
              <button className="form__button ">
                {buttonState === "default" ? (
                  ...
                  <span className="form__button-sending">
                    <Image 
                      src="/projects/oraculux/icons/form/success.svg"
