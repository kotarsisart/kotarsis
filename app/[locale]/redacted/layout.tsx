...
export async function generateMetadata({
  ...
  const languages = Object.fromEntries(
    Object.keys(messages).map((lang) => [
      lang,
      `https://kotarsis.com/${lang}/redacted`,
    ])
  );
  ...
  return {
    ...
    icons: {
      icon: [
        {
          url: "/projects/redacted/favicon/favicon.svg",
          type: "image/svg+xml",
        },
        {
          url: "/projects/redacted/favicon/favicon.ico",
        },
        {
          url: "/projects/redacted/favicon/icon-16.png",
          sizes: "16x16",
          type: "image/png",
        },
        {
          url: "/projects/redacted/favicon/icon-32.png",
          sizes: "32x32",
          type: "image/png",
        },
      ],
      ...
      apple: [
        {
          url: "/projects/redacted/favicon/apple-touch-icon.png",
          sizes: "180x180",
        }
      ]
    },
    ...
    alternates: {
      canonical: `https://kotarsis.com/${locale}/redacted`,
      languages,
    },
  };
}
